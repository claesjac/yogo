...
#line 20 "lib/grammar.y"

#include "parser.h"
#include "emitter.h"
#line 14 "lib/grammar.c"
...
**    yogoc_ParseTOKENTYPE     is the data type used for minor tokens given 
**                       directly to the parser from the tokenizer.
**    YYMINORTYPE        is the data type used for all minor tokens.
**                       This is typically a union of many types, one of
**                       which is yogoc_ParseTOKENTYPE.  The entry in the union
**                       for base tokens is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    yogoc_ParseARG_SDECL     A static variable declaration for the %extra_argument
**    yogoc_ParseARG_PDECL     A parameter declaration for the %extra_argument
**    yogoc_ParseARG_STORE     Code to store %extra_argument into yypParser
**    yogoc_ParseARG_FETCH     Code to extract %extra_argument from yypParser
...
#define yogoc_ParseTOKENTYPE YogocToken *
typedef union {
  int yyinit;
  yogoc_ParseTOKENTYPE yy0;
} YYMINORTYPE;
#ifndef YYSTACKDEPTH
#define YYSTACKDEPTH 100
#endif
#define yogoc_ParseARG_SDECL YogocEmitter *emit;
#define yogoc_ParseARG_PDECL ,YogocEmitter *emit
#define yogoc_ParseARG_FETCH YogocEmitter *emit = yypParser->emit
#define yogoc_ParseARG_STORE yypParser->emit = emit
#define YYNSTATE 36
#define YYNRULE 26
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    20,   19,   18,   17,   16,   15,   14,   35,   34,   33,
 /*    10 */    32,   31,   30,   36,    9,   23,   22,   21,    5,   29,
 /*    20 */     9,    6,    3,   12,    5,   11,   26,    6,    3,    7,
 /*    30 */    28,    8,   63,    2,   24,   27,    1,   25,    8,   13,
 /*    40 */    10,   64,    4,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    13,   14,   15,   16,   17,   18,   19,   23,   24,   25,
 /*    10 */    26,   27,   28,    0,    1,   10,   11,   12,    5,    3,
 /*    20 */     1,    8,    9,    2,    5,    4,    7,    8,    9,    4,
 /*    30 */     3,    6,   21,   22,    3,   29,   22,   29,    6,   29,
 /*    40 */    31,   32,   30,
};
...
static const signed char yy_shift_ofst[] = {
 /*     0 */   -14,   19,   13,  -13,    5,   25,   32,   32,  -14,   21,
 /*    10 */    31,   27,   16,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */    11,  -16,  -16,   12,    9,   10,    8,    6,   14,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    38,   62,   62,   61,   62,   62,   62,   62,   38,   62,
 /*    10 */    62,   62,   62,   47,   60,   59,   58,   57,   56,   55,
 /*    20 */    54,   53,   52,   51,   50,   49,   48,   46,   45,   44,
 /*    30 */    43,   42,   41,   40,   39,   37,
};
...
struct yyParser {
  ...
  yogoc_ParseARG_SDECL                /* A place to hold %extra_argument */
#if YYSTACKDEPTH<=0
...
** None.
*/
void yogoc_ParseTrace(FILE *TraceFILE, char *zTracePrompt){
...
static const char *const yyTokenName[] = { 
  "$",             "PACKAGE",       "PKGNAME",       "SEMI",        
  "IDENTIFIER",    "SUB",           "OPEN_CURLY",    "CLOSE_CURLY", 
  "DO",            "MY",            "SCALAR_VAR",    "HASH_VAR",    
  "ARRAY_VAR",     "INTEGER",       "DOUBLE",        "STRING",      
  "HASH",          "ARRAY",         "ANY",           "OBJECT",      
  "error",         "input",         "stmtlist",      "stmt",        
  "package",       "named_sub",     "anon_sub",      "var_decl",    
  "do",            "block",         "type",          "var",         
};
#endif /* NDEBUG */
...
** to yogoc_Parse and free_parser.
*/
void *yogoc_ParseAlloc(void *(*mallocProc)(size_t)){
  yyParser *pParser;
...
**       obtained from yogoc_ParserAlloc.
** <li>  A pointer to a function used to reclaim memory obtained
**       from malloc.
** </ul>
*/
void yogoc_ParseFree(
...
*/
#ifdef YYTRACKMAXSTACKDEPTH
int yogoc_ParseStackPeak(void *p){
  yyParser *pParser = (yyParser*)p;
...
static void yyStackOverflow(yyParser *yypParser, YYMINORTYPE *yypMinor){
   ...
   ** stack every overflows */
   yogoc_ParseARG_STORE; /* Suppress warning about unused %extra_argument var */
}
...
static void yy_parse_failed(
  ...
  ** parser fails */
  yogoc_ParseARG_STORE; /* Suppress warning about unused %extra_argument variable */
}
...
** "alloc_parser" which describes the current state of the parser.
...
void yogoc_Parse(
  ...
  yogoc_ParseTOKENTYPE yyminor       /* The value for the token */
  yogoc_ParseARG_PDECL               /* Optional %extra_argument parameter */
){
